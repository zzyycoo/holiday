(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var e={selectedServices:new Set,currentHotel:null,guestCount:1,guests:new Map,carCount:1,cars:new Map,golfGuests:[],busRoutes:{hcmToHt:!1,htToHcm:!1},isA171Mode:!1,a171WithRoom:!1,a171GuestCount:0,a171SubjectType:`patron`,generatedEmail:null};function t(){e.selectedServices.clear(),e.currentHotel=null,e.guestCount=1,e.guests.clear(),e.carCount=1,e.cars.clear(),e.golfGuests=[],e.busRoutes={hcmToHt:!1,htToHcm:!1},e.isA171Mode=!1,e.a171WithRoom=!1,e.a171GuestCount=0,e.a171SubjectType=`patron`,e.generatedEmail=null}function n(t){return e.selectedServices.has(t)?(e.selectedServices.delete(t),!1):(e.selectedServices.add(t),!0)}function r(t){return e.selectedServices.has(t)}var i={hotels:{IC:{name:`IC`,displayName:`InterContinental`,roomTypes:[{types:[`KDXN`,`KDXS`,`TDXN`,`TDXS`,`KLON`,`KLOS`,`TLON`,`TLOS`],promotion:188},{types:[`KOTS`,`KOTN`,`TOTS`,`TOTN`],promotion:188},{types:[`KVUS`,`KVUN`,`TVUS`,`TVUN`],promotion:388},{types:[`XEXS`,`XEXN`,`XOTS`,`XOTN`,`XVUS`,`XVUN`],promotion:3188},{types:[`XFTS`,`XFTN`,`XLOS`,`XLON`],promotion:3888}],quickTypes:[`KOTS`,`KVUS`,`TVUS`,`TOTS`]},HIR:{name:`HIR`,displayName:`Ho Tram`,roomTypes:[{types:[`TSTS`,`TSTN`,`KPUS`,`TPUN`,`TPU`],promotion:188},{types:[`TVUN`,`TVUS`,`KLON`,`KLOS`],promotion:188},{types:[`KOTS`,`TOTS`],promotion:388},{types:[`XOTN`,`XOTS`,`XFTN`,`XFTS`,`XLOS`,`XCIS`],promotion:888},{types:[`X2ON`,`X2OS`,`XDBS`],promotion:1888},{types:[`XVUN`,`XVUS`],promotion:2188},{types:[`X2AN`,`X2AS`],promotion:3188}],quickTypes:[`KLOS`,`TVUS`,`KLON`,`TSTS`]},IXORA:{name:`IXORA`,displayName:`Ixora`,roomTypes:[{types:[`1BACC`,`1BSC`,`1BDO`],promotion:188},{types:[`1BPG`],promotion:188},{types:[`2BPO`],promotion:3188},{types:[`2BVP`],promotion:5188},{types:[`2BBV`],promotion:7188},{types:[`3BPV`],promotion:8188},{types:[`3BBV`],promotion:9188}],quickTypes:[`1BACC`,`1BPG`,`2BPO`,`2BVP`]}},agents:{quickSelect:[{code:`IM`,name:`IM`},{code:`A03`,name:`A03 Tun Naing`},{code:`A40`,name:`A40 Wang Kan`},{code:`A111`,name:`A111`},{code:`A165`,name:`A165`},{code:`A171`,name:`A171`},{code:`A173`,name:`A173`}]},services:{room:{enabled:!0,icon:`🏨`,title:`Room Booking`},car:{enabled:!0,icon:`🚗`,title:`Car Service`},golf:{enabled:!0,icon:`⛳`,title:`Golf Booking`},bus:{enabled:!0,icon:`🚌`,title:`Bus Service`}}},{hotels:a}=i;function o(){return a}function s(e){let t=a[e];return t?t.quickTypes:[]}function c(e,t){let n=a[e];if(!n)return null;for(let e of n.roomTypes)if(e.types.includes(t))return e.promotion;return null}function l(){return i.agents.quickSelect}function u(){return i.services}function d(e){if(!e)return``;let t=new Date(e+`T00:00:00`);return`${t.getDate().toString().padStart(2,`0`)}-${[`Jan`,`Feb`,`Mar`,`Apr`,`May`,`Jun`,`Jul`,`Aug`,`Sep`,`Oct`,`Nov`,`Dec`][t.getMonth()]}-${t.getFullYear()}`}function f(e){if(!e)return``;let t=new Date(e+`T00:00:00`),n=t.getDate();return`${n+(n===1?`st`:n===2?`nd`:n===3?`rd`:`th`)}-${[`Jan`,`Feb`,`Mar`,`Apr`,`May`,`Jun`,`Jul`,`Aug`,`Sep`,`Oct`,`Nov`,`Dec`][t.getMonth()]}`}function p(){let e=new Date;return`${e.getFullYear()}-${String(e.getMonth()+1).padStart(2,`0`)}-${String(e.getDate()).padStart(2,`0`)}`}function m(){let e=new Date;return e.setDate(e.getDate()+1),`${e.getFullYear()}-${String(e.getMonth()+1).padStart(2,`0`)}-${String(e.getDate()).padStart(2,`0`)}`}function h(e,t){let n=(e||``).trim(),r=(t||``).trim(),i=r&&r.toLowerCase()!==`new`,a=n&&n.toLowerCase()!==`new`;return i?r:a?n:`New`}var g=1,_=null;function ee(){te(),v(),y(),b(),T();let e=document.getElementById(`btn-add-guest`);e&&e.addEventListener(`click`,()=>T())}function te(){let e=document.getElementById(`agent-selector`);if(!e)return;let t=l();e.innerHTML=`
  ...
  `,setTimeout(()=>x(),0))}function b(){let e=document.getElementById(`authorizer-selector`);e&&(e.innerHTML=`
  ...
  `)}function x(){let e=document.getElementById(`dateRangePicker`),t=document.getElementById(`checkIn`),n=document.getElementById(`checkOut`);if(!(!e||!t||!n))if(S(t.value,n.value),typeof Litepicker<`u`)_&&_.destroy(),_=new Litepicker({element:e,singleMode:!1,startDate:t.value,endDate:n.value,format:`DD MMM YYYY`,delimiter:` → `,tooltipText:{one:`night`,other:`nights`},tooltipNumber:e=>e-1,setup:e=>{e.on(`selected`,(e,r)=>{t.value=e.format(`YYYY-MM-DD`),n.value=r.format(`YYYY-MM-DD`),S(t.value,n.value)})}});else{e.style.display=`none`;let r=document.createElement(`div`);r.className=`form-row`,r.innerHTML=`
      <div class="form-group">
    ...
    `,e.parentNode.appendChild(r),document.getElementById(`checkInNative`)?.addEventListener(`change`,e=>{t.value=e.target.value}),document.getElementById(`checkOutNative`)?.addEventListener(`change`,e=>{n.value=e.target.value})}}function S(e,t){let n=document.getElementById(`dateRangePicker`),r=document.getElementById(`dateRangeDisplay`);if(!e||!t)return;let i=new Date(e+`T00:00:00`),a=new Date(t+`T00:00:00`),o=Math.round((a-i)/(1e3*60*60*24)),s=e=>{let t=new Date(e);return`${t.getDate()} ${[`Jan`,`Feb`,`Mar`,`Apr`,`May`,`Jun`,`Jul`,`Aug`,`Sep`,`Oct`,`Nov`,`Dec`][t.getMonth()]}`};n&&(n.value=`${s(i)} → ${s(a)}`),r&&o>0?r.textContent=`${o} night${o>1?`s`:``}`:r&&(r.textContent=``)}function C(e,t){let n=document.getElementById(`agentName`);n&&(n.value=t),document.querySelectorAll(`.agent-btn`).forEach(t=>{t.classList.toggle(`active`,t.dataset.agent===e)})}function w(t){e.currentHotel=t,document.querySelectorAll(`.hotel-btn`).forEach(e=>{e.classList.toggle(`active`,e.dataset.hotel===t)}),ne(t)}function T(){let t=document.getElementById(`guests-container`);if(!t)return;let n=g++;e.guests.set(n,{id:n,sharers:[]});let r=document.createElement(`div`);return r.className=`guest-card`,r.id=`guest-${n}`,r.innerHTML=`
...
Thank you`}function re(){let t=[];document.getElementById(`agentName`)?.value?.trim()||t.push(`Agent name is required`),e.currentHotel||t.push(`Please select a hotel`);let n=document.getElementById(`checkIn`)?.value,r=document.getElementById(`checkOut`)?.value;(!n||!r)&&t.push(`Check-in and check-out dates are required`);let i=!1;return e.guests.forEach((e,t)=>{if(!document.getElementById(`guest-${t}`))return;let n=document.getElementById(`guestName-${t}`)?.value?.trim(),r=document.getElementById(`roomType-${t}`)?.value;n&&r&&(i=!0)}),i||t.push(`Please add at least one complete guest with name and room type`),t}window.app.setAgent=C,window.app.selectHotel=w,window.app.removeGuestForm=E,window.app.addSharerForm=D,window.app.removeSharerForm=O,window.app.setRoomType=A,window.app.setRoomTypeFromSelect=j,window.app.searchPID=N;var ie=1;function ae(){let t=!e.selectedServices.has(`room`),n=document.getElementById(`car-tip`);if(n&&!t&&(n.style.display=`block`),t){let e=document.getElementById(`car-section`);if(e){let t=document.createElement(`div`);t.className=`form-row`,t.style.marginBottom=`1rem`,t.innerHTML=`
        <div class="form-group">
          <label>Agent</label>
      ...
      `,e.insertBefore(t,document.getElementById(`cars-container`))}}F();let r=document.getElementById(`btn-add-car`);r&&(r.onclick=()=>F())}function F(){let t=document.getElementById(`cars-container`);if(!t)return;let n=ie++;e.cars.set(n,{id:n});let r=!e.selectedServices.has(`room`),i=document.getElementById(`checkIn`)?.value||new Date().toISOString().split(`T`)[0],a=``;if(!r){let e=document.getElementById(`guestName-1`)?.value;e&&(a=e)}let o=document.createElement(`div`);return o.className=`item-group`,o.id=`car-${n}`,o.innerHTML=`
...
Thank you`}window.app.removeCarForm=I,window.app.setLocation=L;var z=1;function B(){let t=document.getElementById(`golf-section`);if(!t)return;if(e.selectedServices.has(`room`)){let e=document.createElement(`div`);e.id=`golf-sync-section`,e.innerHTML=`
    ...
    `,t.insertBefore(e,t.children[1])}let n=document.createElement(`div`);n.id=`golf-guests-container`,t.insertBefore(n,document.getElementById(`golf-pax`)?.parentNode?.parentNode),V();let r=document.createElement(`button`);r.type=`button`,r.className=`btn btn-outline`,r.innerHTML=`<span>+</span> Add Golf Guest`,r.onclick=()=>V(),t.appendChild(r)}function V(){let t=document.getElementById(`golf-guests-container`);if(!t)return;let n=z++;e.golfGuests.push(n);let r=document.createElement(`div`);return r.className=`guest-group`,r.id=`golfGuest-${n}`,r.innerHTML=`
    <div class="guest-header">
...
Thank you`}window.app.removeGolfGuestForm=H,window.app.updateGolfPax=U,window.app.syncGolfGuests=W;function K(){let t=document.getElementById(`bus-section`);if(!t)return;let n=!e.selectedServices.has(`room`);if(n){let e=document.createElement(`div`);e.id=`bus-agent-section`,e.innerHTML=`
      <div class="form-row" style="margin-bottom: 1rem;">
        <div class="form-group">
          <label>Agent</label>
