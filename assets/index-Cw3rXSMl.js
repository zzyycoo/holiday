(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var e={selectedServices:new Set,currentHotel:null,guestCount:1,guests:new Map,carCount:1,cars:new Map,golfGuests:[],busRoutes:{hcmToHt:!1,htToHcm:!1},isA171Mode:!1,a171WithRoom:!1,a171GuestCount:0,a171SubjectType:`patron`,generatedEmail:null};function t(){e.selectedServices.clear(),e.currentHotel=null,e.guestCount=1,e.guests.clear(),e.carCount=1,e.cars.clear(),e.golfGuests=[],e.busRoutes={hcmToHt:!1,htToHcm:!1},e.isA171Mode=!1,e.a171WithRoom=!1,e.a171GuestCount=0,e.a171SubjectType=`patron`,e.generatedEmail=null}function n(t){return e.selectedServices.has(t)?(e.selectedServices.delete(t),!1):(e.selectedServices.add(t),!0)}function r(t){return e.selectedServices.has(t)}function i(t){e.isA171Mode=t}var a={hotels:{IC:{name:`IC`,displayName:`InterContinental`,roomTypes:[{types:[`KDXN`,`KDXS`,`TDXN`,`TDXS`,`KLON`,`KLOS`,`TLON`,`TLOS`],promotion:188},{types:[`KOTS`,`KOTN`,`TOTS`,`TOTN`],promotion:188},{types:[`KVUS`,`KVUN`,`TVUS`,`TVUN`],promotion:388},{types:[`XEXS`,`XEXN`,`XOTS`,`XOTN`,`XVUS`,`XVUN`],promotion:3188},{types:[`XFTS`,`XFTN`,`XLOS`,`XLON`],promotion:3888}],quickTypes:[`KOTS`,`KVUS`,`TVUS`,`TOTS`]},HIR:{name:`HIR`,displayName:`Ho Tram`,roomTypes:[{types:[`TSTS`,`TSTN`,`KPUS`,`TPUN`,`TPU`],promotion:188},{types:[`TVUN`,`TVUS`,`KLON`,`KLOS`],promotion:188},{types:[`KOTS`,`TOTS`],promotion:388},{types:[`XOTN`,`XOTS`,`XFTN`,`XFTS`,`XLOS`,`XCIS`],promotion:888},{types:[`X2ON`,`X2OS`,`XDBS`],promotion:1888},{types:[`XVUN`,`XVUS`],promotion:2188},{types:[`X2AN`,`X2AS`],promotion:3188}],quickTypes:[`KLOS`,`TVUS`,`KLON`,`TSTS`]},IXORA:{name:`IXORA`,displayName:`Ixora`,roomTypes:[{types:[`1BACC`,`1BSC`,`1BDO`],promotion:188},{types:[`1BPG`],promotion:188},{types:[`2BPO`],promotion:3188},{types:[`2BVP`],promotion:5188},{types:[`2BBV`],promotion:7188},{types:[`3BPV`],promotion:8188},{types:[`3BBV`],promotion:9188}],quickTypes:[`1BACC`,`1BPG`,`2BPO`,`2BVP`]}},agents:{quickSelect:[{code:`IM`,name:`IM`},{code:`A03`,name:`A03 Tun Naing`},{code:`A40`,name:`A40 Wang Kan`},{code:`A111`,name:`A111`},{code:`A165`,name:`A165`},{code:`A171`,name:`A171`},{code:`A173`,name:`A173`}]},services:{room:{enabled:!0,icon:`🏨`,title:`Room Booking`},car:{enabled:!0,icon:`🚗`,title:`Car Service`},golf:{enabled:!0,icon:`⛳`,title:`Golf Booking`},bus:{enabled:!0,icon:`🚌`,title:`Bus Service`}}},{hotels:o}=a;function s(){return o}function c(e){let t=o[e];return t?t.quickTypes:[]}function l(e,t){let n=o[e];if(!n)return null;for(let e of n.roomTypes)if(e.types.includes(t))return e.promotion;return null}function u(){return a.agents.quickSelect}function d(e){if(!e)return``;let t=new Date(e+`T00:00:00`);return`${t.getDate().toString().padStart(2,`0`)}-${[`Jan`,`Feb`,`Mar`,`Apr`,`May`,`Jun`,`Jul`,`Aug`,`Sep`,`Oct`,`Nov`,`Dec`][t.getMonth()]}-${t.getFullYear()}`}function f(e){if(!e)return``;let t=new Date(e+`T00:00:00`),n=t.getDate();return`${n+(n===1?`st`:n===2?`nd`:n===3?`rd`:`th`)}-${[`Jan`,`Feb`,`Mar`,`Apr`,`May`,`Jun`,`Jul`,`Aug`,`Sep`,`Oct`,`Nov`,`Dec`][t.getMonth()]}`}function p(){let e=new Date;return`${e.getFullYear()}-${String(e.getMonth()+1).padStart(2,`0`)}-${String(e.getDate()).padStart(2,`0`)}`}function m(){let e=new Date;return e.setDate(e.getDate()+1),`${e.getFullYear()}-${String(e.getMonth()+1).padStart(2,`0`)}-${String(e.getDate()).padStart(2,`0`)}`}function h(e,t){let n=(e||``).trim(),r=(t||``).trim(),i=r&&r.toLowerCase()!==`new`,a=n&&n.toLowerCase()!==`new`;return i?r:a?n:`New`}var g=1;function _(){ee(),te(),v(),y(),S();let e=document.getElementById(`btn-add-guest`);e&&e.addEventListener(`click`,()=>S())}function ee(){let e=document.getElementById(`agent-selector`);if(!e)return;let t=u();e.innerHTML=`
  ...
  `}function te(){let e=document.getElementById(`hotel-selector`);if(!e)return;let t=s();e.innerHTML=Object.entries(t).map(([e,t])=>`
  ...
  `).join(``)}function v(){let e=document.getElementById(`date-selector`);e&&(e.innerHTML=`
    <div class="form-group">
      ...
      <div id="stayRangeDisplayBox" class="form-input" style="cursor: pointer; user-select: none; -webkit-user-select: none; touch-action: manipulation; min-height: 44px; display: flex; align-items: center; color: var(--text-secondary);" onclick="window.initDateRangePicker(); if(window.dateRangePicker){window.dateRangePicker.show();}else{alert('Loading calendar...');}">Select dates...</div>
  ...
  `,setTimeout(()=>{b(),typeof Litepicker>`u`&&window.addEventListener(`load`,b)},50))}function y(){let e=document.getElementById(`authorizer-selector`);e&&(e.innerHTML=`
    <div class="form-group">
  ...
  `)}function b(){if(window.dateRangePicker&&typeof window.dateRangePicker.show==`function`){window.dateRangePicker.show();return}let e=document.getElementById(`stayRangeDisplayBox`),t=document.getElementById(`checkIn`),n=document.getElementById(`checkOut`);if(!e||!t||!n){console.error(`Date picker elements not found`);return}if(x(t.value,n.value),typeof Litepicker>`u`){console.log(`Litepicker not loaded, retrying...`),setTimeout(b,300);return}window.dateRangePicker&&window.dateRangePicker.destroy(),window.dateRangePicker=new Litepicker({element:e,singleMode:!1,startDate:t.value,endDate:n.value,format:`DD MMM YYYY`,delimiter:` → `,tooltipText:{one:`night`,other:`nights`},tooltipNumber:e=>e-1,setup:e=>{e.on(`selected`,(e,r)=>{t.value=e.format(`YYYY-MM-DD`),n.value=r.format(`YYYY-MM-DD`),x(t.value,n.value)})}}),setTimeout(()=>{window.dateRangePicker&&typeof window.dateRangePicker.show==`function`&&window.dateRangePicker.show()},50),console.log(`Litepicker initialized`)}window.initDateRangePicker=b;function x(e,t){let n=document.getElementById(`stayRangeDisplayBox`),r=document.getElementById(`dateRangeDisplay`);if(!e||!t)return;let i=new Date(e+`T00:00:00`),a=new Date(t+`T00:00:00`),o=Math.round((a-i)/(1e3*60*60*24)),s=e=>{let t=new Date(e);return`${t.getDate()} ${[`Jan`,`Feb`,`Mar`,`Apr`,`May`,`Jun`,`Jul`,`Aug`,`Sep`,`Oct`,`Nov`,`Dec`][t.getMonth()]}`};n&&(n.textContent=`${s(i)} → ${s(a)}`,n.style.color=`var(--text)`),r&&o>0&&(r.textContent=`${o} night${o>1?`s`:``}`)}function ne(e,t){let n=document.getElementById(`agentName`);n&&(n.value=t),document.querySelectorAll(`.agent-btn`).forEach(t=>{t.classList.toggle(`active`,t.dataset.agent===e)})}function re(t){e.currentHotel=t,document.querySelectorAll(`.hotel-btn`).forEach(e=>{e.classList.toggle(`active`,e.dataset.hotel===t)}),ae(t)}function S(){let t=document.getElementById(`guests-container`);if(!t)return;let n=g++;e.guests.set(n,{id:n,sharers:[]});let r=document.createElement(`div`);return r.className=`guest-card`,r.id=`guest-${n}`,r.innerHTML=`
...
Promotion: ${_}
Deposit: No
Trip authorizer: ${r}`}function le(){let t=[];document.getElementById(`agentName`)?.value?.trim()||t.push(`Agent name is required`),e.currentHotel||t.push(`Please select a hotel`);let n=document.getElementById(`checkIn`)?.value,r=document.getElementById(`checkOut`)?.value;(!n||!r)&&t.push(`Check-in and check-out dates are required`);let i=!1;return e.guests.forEach((e,t)=>{if(!document.getElementById(`guest-${t}`))return;let n=document.getElementById(`guestName-${t}`)?.value?.trim(),r=document.getElementById(`roomType-${t}`)?.value;n&&r&&(i=!0)}),i||t.push(`Please add at least one complete guest with name and room type`),t}var ue=1;function de(){let t=!e.selectedServices.has(`room`),n=document.getElementById(`car-tip`);if(n&&!t&&(n.style.display=`block`),t){let e=document.getElementById(`car-section`);if(e){let t=document.createElement(`div`);t.className=`form-row`,t.style.marginBottom=`1rem`,t.innerHTML=`
        <div class="form-group">
          <label>Agent</label>
      ...
      `,e.insertBefore(t,document.getElementById(`cars-container`))}}O();let r=document.getElementById(`btn-add-car`);r&&(r.onclick=()=>O())}function O(){let t=document.getElementById(`cars-container`);if(!t)return;let n=ue++;e.cars.set(n,{id:n});let r=!e.selectedServices.has(`room`),i=document.getElementById(`checkIn`)?.value||new Date().toISOString().split(`T`)[0],a=``;if(!r){let e=document.getElementById(`guestName-1`)?.value;e&&(a=e)}let o=document.createElement(`div`);return o.className=`item-group`,o.id=`car-${n}`,o.innerHTML=`
...
`)}
Payment: ${n}
Authorizer: ${r}`}var M=1;function N(){let t=document.getElementById(`golf-section`);if(!t)return;if(e.selectedServices.has(`room`)){let e=document.createElement(`div`);e.id=`golf-sync-section`,e.innerHTML=`
    ...
    `,t.insertBefore(e,t.children[1])}let n=document.createElement(`div`);n.id=`golf-guests-container`,t.insertBefore(n,document.getElementById(`golf-pax`)?.parentNode?.parentNode),P();let r=document.createElement(`button`);r.type=`button`,r.className=`btn btn-outline`,r.innerHTML=`<span>+</span> Add Golf Guest`,r.onclick=()=>P(),t.appendChild(r)}function P(){let t=document.getElementById(`golf-guests-container`);if(!t)return;let n=M++;e.golfGuests.push(n);let r=document.createElement(`div`);return r.className=`guest-group`,r.id=`golfGuest-${n}`,r.innerHTML=`
    <div class="guest-header">
...
Note: ${a}
Payment: ${r}
Authorizer: ${i}`}function z(){let t=document.getElementById(`bus-section`);if(!t)return;let n=!e.selectedServices.has(`room`);if(n){let e=document.createElement(`div`);e.id=`bus-agent-section`,e.innerHTML=`
      <div class="form-row" style="margin-bottom: 1rem;">
        <div class="form-group">
          <label>Agent</label>
...
Name: ${t}
${o}
Authorizer: ${n}`}var H={room:{enabled:!0,icon:`🏨`,title:`Room Booking`},car:{enabled:!0,icon:`🚗`,title:`Car Service`},golf:{enabled:!0,icon:`⛳`,title:`Golf Booking`},bus:{enabled:!0,icon:`🚌`,title:`Bus Service`}};function fe(){return H}var U=`3.2.18`;function pe(){t(),me(),he(),be(),window.pidDatabase=new Map,window.oldPIDIndex=new Map,window.newPIDIndex=new Map,window.pidDatabaseLoaded=!1,console.log(`Booking App v${U} initialized`)}function me(){let e=document.querySelector(`.app-header`);e&&(e.innerHTML=`
      <h1>🦾 A KANG TOOLS</h1>
      <div class="version">v${U} | ${Ce()}</div>
    `)}function he(){let e=document.getElementById(`service-selector`);if(!e){console.error(`Service selector container not found`);return}try{let t=fe();if(console.log(`Services loaded:`,t),!t||typeof t!=`object`){console.error(`Invalid services data:`,t),e.innerHTML=`<p style="color:red">Error loading services</p>`;return}let n=Object.entries(t).filter(([e,t])=>t&&t.enabled);if(console.log(`Filtered services:`,n),n.length===0){e.innerHTML=`<p>No services available</p>`;return}e.innerHTML=n.map(([e,t])=>`
      <div class="service-card" data-service="${e}" onclick="window.app.selectService('${e}')">
        <span class="title">${t.title||e}</span>
      </div>
    `).join(``),console.log(`Service selector rendered successfully`)}catch(t){console.error(`Error rendering service selector:`,t),e.innerHTML=`<p style="color:red">Error: ${t.message}</p>`}}function ge(e){let t=document.querySelector(`[data-service="${e}"]`);n(e)?(t&&t.classList.add(`selected`),_e(e),ye(e)):(t&&t.classList.remove(`selected`),ve(e))}function _e(e){let t=document.getElementById(`${e}-section`);t&&(t.style.display=`block`,t.classList.add(`fade-in`),setTimeout(()=>{t.scrollIntoView({behavior:`smooth`,block:`start`})},100))}function ve(e){let t=document.getElementById(`${e}-section`);t&&(t.style.display=`none`,t.classList.remove(`fade-in`))}function ye(e){switch(e){case`room`:_();break;case`car`:de();break;case`golf`:N();break;case`bus`:z();break;case`a171`:we();break}}function be(){let e=document.getElementById(`btn-generate`);e&&e.addEventListener(`click`,W);let t=document.getElementById(`btn-copy`);t&&t.addEventListener(`click`,G);let n=document.getElementById(`btn-send`);n&&n.addEventListener(`click`,K)}function W(){let t=document.getElementById(`email-preview`),n=[];if(e.selectedServices.has(`room`)){let e=le();e.length>0&&n.push(...e)}if(n.length>0){q(n[0],`error`);return}let i=[],a=``;try{if(r(`room`)){let e=ce();i.push(e);let t=e.match(/Subject:\s*(.+?)\n/);a=t?t[1].trim():`Booking Request`}if(r(`car`)){let e=j();if(i.push(e),!a){let t=e.match(/Subject:\s*(.+?)\n/);a=t?t[1].trim():`Car Service Request`}}if(r(`golf`)){let e=R();if(i.push(e),!a){let t=e.match(/Subject:\s*(.+?)\n/);a=t?t[1].trim():`Golf Booking Request`}}if(r(`bus`)){let e=V();if(i.push(e),!a){let t=e.match(/Subject:\s*(.+?)\n/);a=t?t[1].trim():`Bus Service Request`}}if(r(`a171`)){let e=Ee();if(i.push(e),!a){let t=e.match(/Subject:\s*(.+?)\n/);a=t?t[1].trim():`Patron Registration`}}if(i.length===0){t.textContent=`Please select at least one service.`;return}let e=``;if(i.length===1)e=i[0];else{let t=i.map(e=>e.replace(/^Subject:\s*.+?\n+/m,``).trim());e=`Subject: ${a}\n\n${t.join(`

---

`)}`}window.generatedEmail=e,t.innerHTML=e.replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/\r?\n/g,`<br>
`),q(`✓ Email generated!`,`success`),document.getElementById(`email-preview-section`)?.scrollIntoView({behavior:`smooth`})}catch(e){q(e.message||`Error generating email`,`error`),console.error(e)}}async function G(){if(!window.generatedEmail){q(`Please generate email first`,`warning`);return}let e=window.generatedEmail;if(navigator.clipboard&&navigator.clipboard.write)try{let t=`<!DOCTYPE html><html><body><p style="font-family:Arial,sans-serif;font-size:14px;line-height:1.6;white-space:pre-wrap;">${e.replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/\n/g,`<br>`)}</p></body></html>`,n=new ClipboardItem({"text/plain":new Blob([e],{type:`text/plain`}),"text/html":new Blob([t],{type:`text/html`})});await navigator.clipboard.write([n]),q(`✓ Copied! Paste directly into Outlook/Gmail`,`success`);return}catch{}try{await navigator.clipboard.writeText(e),q(`✓ Email copied to clipboard!`,`success`)}catch{let t=document.createElement(`textarea`);t.value=e,t.style.cssText=`position:fixed;opacity:0;top:0;left:0;`,document.body.appendChild(t),t.select();try{document.execCommand(`copy`),q(`✓ Email copied to clipboard!`,`success`)}catch{q(`Copy failed. Please copy manually.`,`error`)}finally{document.body.removeChild(t)}}}function K(){if(!window.generatedEmail){q(`Please generate email first`,`warning`);return}let t=`Booking Request`,n=window.generatedEmail,r=window.generatedEmail.match(/^Subject:\s*(.+)$/m);r&&(t=r[1].trim(),n=window.generatedEmail.replace(/^Subject:.+\n+/m,``).trim()),n=n.replace(/^Subject:\s*/i,``).trim();let i=encodeURIComponent(n),a,o;e.isA171Mode&&document.getElementById(`a171-subject-type`)?.value===`onedaytrip`?(a=[`casinoaudit@thegrandhotram.com`,`concierge@thegrandhotram.com`,`Front.Desk@thegrandhotram.com`,`grandservice@thegrandhotram.com`,`HIR.receptionist@thegrandhotram.com`,`IC.receptionist@thegrandhotram.com`,`Guestrelations.Management@thegrandhotram.com`,`rooms.coordinator@thegrandhotram.com`].join(`,`),o=[`rewards@thegrandhotram.com`,`im.gcsea@thegrandhotram.com`,`HTR@thegrandhotram.com`].join(`,`)):(a=[`concierge@thegrandhotram.com`,`Front.Desk@thegrandhotram.com`,`grandservice@thegrandhotram.com`,`HIR.receptionist@thegrandhotram.com`,`IC.receptionist@thegrandhotram.com`,`Guestrelations.Management@thegrandhotram.com`,`rooms.coordinator@thegrandhotram.com`].join(`,`),o=[`rewards@thegrandhotram.com`,`im.gcsea@thegrandhotram.com`,`HTR@thegrandhotram.com`].join(`,`)),window.location.href=`mailto:${a}?cc=${encodeURIComponent(o)}&subject=${encodeURIComponent(t)}&body=${i}`,q(`Opening email client...`,`info`)}function xe(){let t=new Date,n=`${String(t.getHours()).padStart(2,`0`)}:${String(t.getMinutes()).padStart(2,`0`)}:${String(t.getSeconds()).padStart(2,`0`)}`,r={};if(e.isA171Mode){let e=[];if(X.forEach((t,n)=>{let r=document.getElementById(`a171-patron-name-${n}`)?.value?.trim(),i=document.getElementById(`a171-patron-oldpid-${n}`)?.value?.trim()||``,a=document.getElementById(`a171-patron-newpid-${n}`)?.value?.trim()||``;r&&e.push({oldPID:i,newPID:a,name:r})}),e.length===0){q(`⚠️ Please add at least one patron name!`,`warning`);return}let t=document.getElementById(`a171-date`),i=t?.dataset?.isoDate||t?.value||``;r={agent:document.getElementById(`a171-agent`)?.value?.trim()||``,checkIn:i,authorizer:``,currentTime:n,guests:e}}else{if(!e.selectedServices.has(`room`)){q(`⚠️ Please select Room Booking to save data!`,`warning`);return}let t=[];if(e.guests.forEach((e,n)=>{if(!document.getElementById(`guest-${n}`))return;let r=document.getElementById(`guestName-${n}`)?.value?.trim(),i=document.getElementById(`guestOldPID-${n}`)?.value?.trim()||``,a=document.getElementById(`guestNewPID-${n}`)?.value?.trim()||`New`;r&&t.push({oldPID:i,newPID:a,name:r}),e.sharers.forEach(e=>{let r=document.getElementById(`sharerName-${n}-${e}`)?.value?.trim(),i=document.getElementById(`sharerOldPID-${n}-${e}`)?.value?.trim()||``,a=document.getElementById(`sharerNewPID-${n}-${e}`)?.value?.trim()||`New`;r&&t.push({oldPID:i,newPID:a,name:r})})}),t.length===0){q(`⚠️ Please add at least one guest!`,`warning`);return}r={agent:document.getElementById(`agentName`)?.value?.trim()||``,checkIn:document.getElementById(`checkIn`)?.value||``,authorizer:document.getElementById(`authorizer`)?.value?.trim()||`Jian.Xu`,currentTime:n,guests:t}}q(`📊 Saving to Google Sheets...`,`info`);let i=document.createElement(`iframe`);i.style.display=`none`,i.name=`saveFrame`,document.body.appendChild(i),i.src=`https://script.google.com/macros/s/AKfycbyOpykMzPHrhi6pcthRdASWMQdjXO0VQJilRd9R67i1_GRqtBOPBcHDD8fJrHNjY1znCg/exec?data=${encodeURIComponent(JSON.stringify(r))}`,setTimeout(()=>{try{document.body.removeChild(i)}catch{}q(`✅ Saved ${r.guests.length} guest(s) to Google Sheets!`,`success`)},2e3)}function q(e,t=`info`){let n=document.querySelector(`.toast`);n&&n.remove();let r=document.createElement(`div`);r.className=`toast ${t}`,r.textContent=e,document.body.appendChild(r),requestAnimationFrame(()=>{r.classList.add(`show`)}),setTimeout(()=>{r.classList.remove(`show`),setTimeout(()=>r.remove(),300)},3e3)}function Se(e){let t=e.target.files[0];if(!t)return;if(q(`📖 Reading PID database...`,`info`),typeof XLSX>`u`){q(`XLSX library not loaded. Please include sheetjs.`,`error`);return}let n=new FileReader;n.onload=function(e){try{let t=new Uint8Array(e.target.result),n=XLSX.read(t,{type:`array`}),r=n.Sheets[n.SheetNames[0]],i=XLSX.utils.sheet_to_json(r);window.pidDatabase.clear(),window.oldPIDIndex.clear(),window.newPIDIndex.clear();let a=0;i.forEach(e=>{let t=String(e[`Old PID`]||``).trim(),n=String(e[`New PID`]||``).trim(),r=String(e[`Player Name`]||``).trim();if(r&&(t||n)){let e=n||t;window.pidDatabase.set(e,{oldPID:t||null,newPID:n||null,name:r}),t&&window.oldPIDIndex.set(t,e),n&&window.newPIDIndex.set(n,e),a++}}),window.pidDatabaseLoaded=!0;let o=document.getElementById(`pid-status`);o&&(o.textContent=`${a.toLocaleString()} records loaded ✓`,o.style.color=`var(--success)`),q(`✓ ${a.toLocaleString()} PID records loaded`,`success`)}catch(e){console.error(`Error reading PID file:`,e),q(`❌ Error reading Excel file`,`error`)}},n.readAsArrayBuffer(t)}var J=`Life is like a box of chocolates. - Forrest Gump(May the Force be with you. - Star Wars(There's no place like home. - The Wizard of Oz(I'll be back. - The Terminator(You're gonna need a bigger boat. - Jaws(Here's looking at you, kid. - Casablanca(Go ahead, make my day. - Sudden Impact(I love the smell of napalm in the morning. - Apocalypse Now(Show me the money! - Jerry Maguire(You can't handle the truth! - A Few Good Men(To infinity and beyond! - Toy Story(Houston, we have a problem. - Apollo 13(Keep your friends close, but your enemies closer. - The Godfather II(The first rule of Fight Club is: You do not talk about Fight Club. - Fight Club(Why so serious? - The Dark Knight(I am your father. - The Empire Strikes Back(Just keep swimming. - Finding Nemo(With great power comes great responsibility. - Spider-Man(Hasta la vista, baby. - Terminator 2(I see dead people. - The Sixth Sense(Carpe diem. Seize the day, boys. - Dead Poets Society(Nobody's perfect. - Some Like It Hot(E.T. phone home. - E.T.(Bond. James Bond. - Dr. No(I'll have what she's having. - When Harry Met Sally(Yo, Adrian! - Rocky(They may take our lives, but they'll never take our freedom! - Braveheart(There's no crying in baseball! - A League of Their Own(You talking to me? - Taxi Driver(Roads? Where we're going we don't need roads. - Back to the Future`.split(`(`);function Ce(){return J[Math.floor(Math.random()*J.length)]}var Y=0,X=new Map;function we(){i(!0),Y=0,X.clear(),setTimeout(()=>Z(),100),$()}function Z(){if(window.a171DatePicker&&typeof window.a171DatePicker.show==`function`)return;let e=document.getElementById(`a171-date`);if(!e){console.error(`A171 date picker element not found`);return}if(typeof Litepicker>`u`){console.log(`Litepicker not loaded, retrying...`),setTimeout(Z,300);return}let t=p();Q(t),window.a171DatePicker&&window.a171DatePicker.destroy(),window.a171DatePicker=new Litepicker({element:e,singleMode:!0,startDate:t,format:`DD MMM YYYY`,setup:e=>{e.on(`selected`,e=>{Q(e.format(`YYYY-MM-DD`))})}}),console.log(`A171 date picker initialized`)}window.initA171DatePicker=Z;function Q(e){let t=document.getElementById(`a171-date`);if(!t||!e)return;let n=new Date(e+`T00:00:00`);t.value=`${n.getDate()} ${[`Jan`,`Feb`,`Mar`,`Apr`,`May`,`Jun`,`Jul`,`Aug`,`Sep`,`Oct`,`Nov`,`Dec`][n.getMonth()]} ${n.getFullYear()}`,t.dataset.isoDate=e}function $(){let e=++Y;X.set(e,{id:e});let t=document.getElementById(`a171-patrons-container`);if(!t)return;let n=document.createElement(`div`);n.id=`a171-patron-${e}`,n.className=`guest-form`,n.style.cssText=`margin-bottom: 1rem; padding: 1rem; background: var(--surface); border-radius: var(--radius-sm); border: 1px solid var(--border);`,n.innerHTML=`
...
`)),`Subject: ${c}\n\n${l}\nAuthorizer: ${i}`}window.app={selectService:ge,setAgent:ne,selectHotel:re,addGuestForm:S,removeGuestForm:C,addSharerForm:ie,removeSharerForm:w,setRoomType:E,setRoomTypeFromSelect:oe,searchPID:se,addCarForm:O,removeCarForm:k,setLocation:A,addGolfGuestForm:P,removeGolfGuestForm:F,updateGolfPax:I,syncGolfGuests:L,toggleBusRoute:B,addA171Patron:$,removeA171Patron:Te,initA171DatePicker:Z,generateAllEmails:W,copyToClipboard:G,sendEmail:K,showToast:q,handlePIDImport:Se,saveToGoogleSheets:xe,formatDate:d,formatDateShort:f,getTodayStr:p,getTomorrowStr:m,resolvePID:h},document.addEventListener(`DOMContentLoaded`,pe);