...
Name: ${t}
${o}
Authorizer: ${n}`}var ue={room:{enabled:!0,icon:`🏨`,title:`Room Booking`},car:{enabled:!0,icon:`🚗`,title:`Car Service`},golf:{enabled:!0,icon:`⛳`,title:`Golf Booking`},bus:{enabled:!0,icon:`🚌`,title:`Bus Service`}};function de(){return ue}var G=`3.2.6`;function fe(){t(),pe(),me(),ye(),window.pidDatabase=new Map,window.oldPIDIndex=new Map,window.newPIDIndex=new Map,window.pidDatabaseLoaded=!1,console.log(`Booking App v${G} initialized`)}function pe(){let e=document.querySelector(`.app-header`);e&&(e.innerHTML=`
      <h1>🦾 A KANG TOOLS</h1>
